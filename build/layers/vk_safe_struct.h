...
struct safe_VkDeviceGeneratedCommandsFeaturesNVX {
    ...
    safe_VkDeviceGeneratedCommandsFeaturesNVX(const VkDeviceGeneratedCommandsFeaturesNVX* pInStruct);
    ...
    ~safe_VkDeviceGeneratedCommandsFeaturesNVX();
    void initialize(const VkDeviceGeneratedCommandsFeaturesNVX* pInStruct);
...
struct safe_VkDeviceGeneratedCommandsLimitsNVX {
    ...
    safe_VkDeviceGeneratedCommandsLimitsNVX(const VkDeviceGeneratedCommandsLimitsNVX* pInStruct);
    ...
    ~safe_VkDeviceGeneratedCommandsLimitsNVX();
    void initialize(const VkDeviceGeneratedCommandsLimitsNVX* pInStruct);
...
struct safe_VkIndirectCommandsLayoutCreateInfoNVX {
    ...
    safe_VkIndirectCommandsLayoutCreateInfoNVX(const VkIndirectCommandsLayoutCreateInfoNVX* pInStruct);
    ...
    ~safe_VkIndirectCommandsLayoutCreateInfoNVX();
    void initialize(const VkIndirectCommandsLayoutCreateInfoNVX* pInStruct);
...
struct safe_VkCmdProcessCommandsInfoNVX {
    ...
    safe_VkCmdProcessCommandsInfoNVX(const VkCmdProcessCommandsInfoNVX* pInStruct);
    safe_VkCmdProcessCommandsInfoNVX(const safe_VkCmdProcessCommandsInfoNVX& src);
    safe_VkCmdProcessCommandsInfoNVX();
    ~safe_VkCmdProcessCommandsInfoNVX();
    void initialize(const VkCmdProcessCommandsInfoNVX* pInStruct);
...
struct safe_VkCmdReserveSpaceForCommandsInfoNVX {
    ...
    VkIndirectCommandsLayoutNVX indirectCommandsLayout;
    uint32_t maxSequencesCount;
    safe_VkCmdReserveSpaceForCommandsInfoNVX(const VkCmdReserveSpaceForCommandsInfoNVX* pInStruct);
    ...
    ~safe_VkCmdReserveSpaceForCommandsInfoNVX();
    void initialize(const VkCmdReserveSpaceForCommandsInfoNVX* pInStruct);
...
struct safe_VkObjectTableCreateInfoNVX {
    ...
    safe_VkObjectTableCreateInfoNVX(const VkObjectTableCreateInfoNVX* pInStruct);
    safe_VkObjectTableCreateInfoNVX(const safe_VkObjectTableCreateInfoNVX& src);
    safe_VkObjectTableCreateInfoNVX();
    ~safe_VkObjectTableCreateInfoNVX();
    void initialize(const VkObjectTableCreateInfoNVX* pInStruct);
