...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #842
...
std::string vk_print_vkcmdprocesscommandsinfonvx(const VkCmdProcessCommandsInfoNVX* pStruct, const std::string prefix);
std::string vk_print_vkcmdreservespaceforcommandsinfonvx(const VkCmdReserveSpaceForCommandsInfoNVX* pStruct, const std::string prefix);
...
std::string vk_print_vkdevicegeneratedcommandsfeaturesnvx(const VkDeviceGeneratedCommandsFeaturesNVX* pStruct, const std::string prefix);
std::string vk_print_vkdevicegeneratedcommandslimitsnvx(const VkDeviceGeneratedCommandsLimitsNVX* pStruct, const std::string prefix);
...
#endif //VK_USE_PLATFORM_WIN32_KHR
std::string vk_print_vkindirectcommandslayoutcreateinfonvx(const VkIndirectCommandsLayoutCreateInfoNVX* pStruct, const std::string prefix);
std::string vk_print_vkindirectcommandslayouttokennvx(const VkIndirectCommandsLayoutTokenNVX* pStruct, const std::string prefix);
std::string vk_print_vkindirectcommandstokennvx(const VkIndirectCommandsTokenNVX* pStruct, const std::string prefix);
...
std::string vk_print_vkobjecttablecreateinfonvx(const VkObjectTableCreateInfoNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttabledescriptorsetentrynvx(const VkObjectTableDescriptorSetEntryNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttableentrynvx(const VkObjectTableEntryNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttableindexbufferentrynvx(const VkObjectTableIndexBufferEntryNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttablepipelineentrynvx(const VkObjectTablePipelineEntryNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttablepushconstantentrynvx(const VkObjectTablePushConstantEntryNVX* pStruct, const std::string prefix);
std::string vk_print_vkobjecttablevertexbufferentrynvx(const VkObjectTableVertexBufferEntryNVX* pStruct, const std::string prefix);
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #850
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
std::string vk_print_vkallocationcallbacks(const VkAllocationCallbacks* pStruct, const std::string prefix)
{
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #866
    ...
    stringstream ss[6];
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ss[0] << "0x" << pStruct->pUserData;
    else
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #866
    ...
    stringstream ss[3];
    string stp_strs[1];
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #961
    if (pStruct->pNext) {
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #965
        tmp_str = dynamic_display((void*)pStruct->pNext, prefix);
        ss[0] << "0x" << &pStruct->pNext;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #976
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1013
    if (pStruct->pApplicationName != NULL) {
        ss[1] << pStruct->pApplicationName;
     } else {
        ss[1] << "";
     }
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #976
        ...
        stp_strs[0] = "";
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #885
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #887
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        stp_strs[1] = "";
        ...
        if (pStruct->pWaitSemaphores) {
            for (uint32_t i = 0; i < pStruct->waitSemaphoreCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #939
                ss[1] << "0x" << pStruct->pWaitSemaphores[i];
                stp_strs[1] += " " + prefix + "pWaitSemaphores[" + index_ss.str() + "].handle = " + ss[1].str() + "\n";
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[1].str("");
            }
        }
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #885
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        ...
        if (pStruct->pBufferBinds) {
            for (uint32_t i = 0; i < pStruct->bufferBindCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #933
                ss[2] << "0x" << &pStruct->pBufferBinds[i];
                tmp_str = vk_print_vksparsebuffermemorybindinfo(&pStruct->pBufferBinds[i], extra_indent);
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #936
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #998
    ss[2] << "0x" << (void*)pStruct->pWaitSemaphores;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #866
    ...
    stringstream ss[6];
    string stp_strs[3];
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #983
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #987
    ss[0].str("");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #983
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #995
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #866
    ...
    string stp_strs[3];
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #885
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #890
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
    stp_strs[0] = "";
    stringstream index_ss;
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        stp_strs[1] = "";
        stringstream index_ss;
        if (pStruct->pIndirectCommandsTokens) {
            for (uint32_t i = 0; i < pStruct->indirectCommandsTokenCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #933
                ss[1] << "0x" << &pStruct->pIndirectCommandsTokens[i];
                tmp_str = vk_print_vkindirectcommandstokennvx(&pStruct->pIndirectCommandsTokens[i], extra_indent);
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #936
                stp_strs[1] += " " + prefix + "pIndirectCommandsTokens[" + index_ss.str() + "] (" + ss[1].str() + ")\n" + tmp_str;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[1].str("");
            }
        }
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[1] << "0x" << pStruct->objectTable;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[2] << "0x" << pStruct->indirectCommandsLayout;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[3] << pStruct->indirectCommandsTokenCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #998
    ss[4] << "0x" << (void*)pStruct->pIndirectCommandsTokens;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[5] << pStruct->maxSequencesCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[6] << "0x" << pStruct->targetCommandBuffer;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[7] << "0x" << pStruct->sequencesCountBuffer;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[8] << "0x" << pStruct->sequencesCountOffset;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[9] << "0x" << pStruct->sequencesIndexBuffer;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[10] << "0x" << pStruct->sequencesIndexOffset;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "objectTable = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "indirectCommandsLayout = " + ss[2].str() + "\n";
    final_str = final_str + prefix + "indirectCommandsTokenCount = " + ss[3].str() + "\n";
    final_str = final_str + prefix + "pIndirectCommandsTokens = " + ss[4].str() + "\n";
    final_str = final_str + prefix + "maxSequencesCount = " + ss[5].str() + "\n";
    final_str = final_str + prefix + "targetCommandBuffer = " + ss[6].str() + "\n";
    final_str = final_str + prefix + "sequencesCountBuffer = " + ss[7].str() + "\n";
    final_str = final_str + prefix + "sequencesCountOffset = " + ss[8].str() + "\n";
    final_str = final_str + prefix + "sequencesIndexBuffer = " + ss[9].str() + "\n";
    final_str = final_str + prefix + "sequencesIndexOffset = " + ss[10].str() + "\n";
    final_str = final_str + stp_strs[1] + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[2] << "0x" << pStruct->indirectCommandsLayout;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[3] << pStruct->maxSequencesCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "objectTable = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "indirectCommandsLayout = " + ss[2].str() + "\n";
    final_str = final_str + prefix + "maxSequencesCount = " + ss[3].str() + "\n";
    final_str = final_str + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #973
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1001
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1001
    ss[1].str(pStruct->computeBindingPointSupport ? "TRUE" : "FALSE");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "computeBindingPointSupport = " + ss[1].str() + "\n";
    final_str = final_str + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[1] << pStruct->maxIndirectCommandsLayoutTokenCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[2] << "0x" << pStruct->maxObjectEntryCounts;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[3] << "0x" << pStruct->minSequenceCountBufferOffsetAlignment;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[4] << "0x" << pStruct->minSequenceIndexBufferOffsetAlignment;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[5] << "0x" << pStruct->minCommandsTokenBufferOffsetAlignment;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "maxIndirectCommandsLayoutTokenCount = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "maxObjectEntryCounts = " + ss[2].str() + "\n";
    final_str = final_str + prefix + "minSequenceCountBufferOffsetAlignment = " + ss[3].str() + "\n";
    final_str = final_str + prefix + "minSequenceIndexBufferOffsetAlignment = " + ss[4].str() + "\n";
    final_str = final_str + prefix + "minCommandsTokenBufferOffsetAlignment = " + ss[5].str() + "\n";
    final_str = final_str + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #983
    ...
    stp_strs[0] = " " + prefix + "imageFormatProperties (" + ss[0].str() + ")\n" + tmp_str;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #987
    ss[0].str("");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #995
    ss[0] << "0x" << &pStruct->imageFormatProperties;
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        ...
        if (pStruct->pTokens) {
            for (uint32_t i = 0; i < pStruct->tokenCount; i++) {
                ...
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #933
                ss[1] << "0x" << &pStruct->pTokens[i];
                tmp_str = vk_print_vkindirectcommandslayouttokennvx(&pStruct->pTokens[i], extra_indent);
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #936
                stp_strs[1] += " " + prefix + "pTokens[" + index_ss.str() + "] (" + ss[1].str() + ")\n" + tmp_str;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[1].str("");
            }
        }
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[1] << "0x" << pStruct->flags;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[2] << pStruct->tokenCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #998
    ss[3] << "0x" << (void*)pStruct->pTokens;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "pipelineBindPoint = " + string_VkPipelineBindPoint(pStruct->pipelineBindPoint) + "\n";
    final_str = final_str + prefix + "flags = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "tokenCount = " + ss[2].str() + "\n";
    final_str = final_str + prefix + "pTokens = " + ss[3].str() + "\n";
    final_str = final_str + stp_strs[1] + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #866
    ...
    stringstream ss[3];
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[0] << pStruct->bindingUnit;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[1] << pStruct->dynamicCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[2] << pStruct->divisor;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "tokenType = " + string_VkIndirectCommandsTokenTypeNVX(pStruct->tokenType) + "\n";
    final_str = final_str + prefix + "bindingUnit = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "dynamicCount = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "divisor = " + ss[2].str() + "\n";
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
std::string vk_print_vkindirectcommandstokennvx(const VkIndirectCommandsTokenNVX* pStruct, const std::string prefix)
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        stp_strs[1] = "";
        stringstream index_ss;
        if (pStruct->pObjectEntryTypes) {
            for (uint32_t i = 0; i < pStruct->objectCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #927
                ss[1] << string_VkObjectEntryTypeNVX(pStruct->pObjectEntryTypes[i]);
                stp_strs[1] += " " + prefix + "pObjectEntryTypes[" + index_ss.str() + "] = " + ss[1].str() + "\n";
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[1].str("");
            }
        }
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        stp_strs[2] = "";
        if (pStruct->pObjectEntryCounts) {
            for (uint32_t i = 0; i < pStruct->objectCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #939
                ss[2] << "0x" << pStruct->pObjectEntryCounts[i];
                stp_strs[2] += " " + prefix + "pObjectEntryCounts[" + index_ss.str() + "] = " + ss[2].str() + "\n";
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[2].str("");
            }
        }
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #892
        stp_strs[3] = "";
        if (pStruct->pObjectEntryUsageFlags) {
            for (uint32_t i = 0; i < pStruct->objectCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #939
                ss[3] << "0x" << pStruct->pObjectEntryUsageFlags[i];
                stp_strs[3] += " " + prefix + "pObjectEntryUsageFlags[" + index_ss.str() + "] = " + ss[3].str() + "\n";
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #949
                ss[3].str("");
            }
        }
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1007
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[1] << "0x" << pStruct->objectCount;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1037
    if (pStruct->pObjectEntryTypes)
        ss[2] << "0x" << pStruct->pObjectEntryTypes << " (See individual array values below)";
    else
        ss[2].str("NULL");
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #998
    ss[3] << "0x" << (void*)pStruct->pObjectEntryCounts;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #998
    ss[4] << "0x" << (void*)pStruct->pObjectEntryUsageFlags;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[5] << "0x" << pStruct->maxUniformBuffersPerDescriptor;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1027: NB: Edit here to choose hex vs dec output by variable name
    ss[6] << "0x" << pStruct->maxStorageBuffersPerDescriptor;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[7] << pStruct->maxStorageImagesPerDescriptor;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[8] << pStruct->maxSampledImagesPerDescriptor;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1030: NB Edit this section to choose hex vs dec output by variable name
    ss[9] << pStruct->maxPipelineLayouts;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "sType = " + string_VkStructureType(pStruct->sType) + "\n";
    final_str = final_str + prefix + "pNext = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "objectCount = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "pObjectEntryTypes = " + ss[2].str() + "\n";
    final_str = final_str + prefix + "pObjectEntryCounts = " + ss[3].str() + "\n";
    final_str = final_str + prefix + "pObjectEntryUsageFlags = " + ss[4].str() + "\n";
    final_str = final_str + prefix + "maxUniformBuffersPerDescriptor = " + ss[5].str() + "\n";
    final_str = final_str + prefix + "maxStorageBuffersPerDescriptor = " + ss[6].str() + "\n";
    final_str = final_str + prefix + "maxStorageImagesPerDescriptor = " + ss[7].str() + "\n";
    final_str = final_str + prefix + "maxSampledImagesPerDescriptor = " + ss[8].str() + "\n";
    final_str = final_str + prefix + "maxPipelineLayouts = " + ss[9].str() + "\n";
    final_str = final_str + stp_strs[3] + stp_strs[2] + stp_strs[1] + stp_strs[0];
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[0] << "0x" << pStruct->flags;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[1] << "0x" << pStruct->pipelineLayout;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[2] << "0x" << pStruct->descriptorSet;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "type = " + string_VkObjectEntryTypeNVX(pStruct->type) + "\n";
    final_str = final_str + prefix + "flags = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "pipelineLayout = " + ss[1].str() + "\n";
    final_str = final_str + prefix + "descriptorSet = " + ss[2].str() + "\n";
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
std::string vk_print_vkobjecttableentrynvx(const VkObjectTableEntryNVX* pStruct, const std::string prefix)
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[0] << "0x" << pStruct->flags;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[1] << "0x" << pStruct->buffer;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "type = " + string_VkObjectEntryTypeNVX(pStruct->type) + "\n";
    final_str = final_str + prefix + "flags = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "buffer = " + ss[1].str() + "\n";
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
std::string vk_print_vkobjecttablepipelineentrynvx(const VkObjectTablePipelineEntryNVX* pStruct, const std::string prefix)
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[0] << "0x" << pStruct->flags;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1023
    ss[1] << "0x" << pStruct->pipeline;
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1050
    final_str = final_str + prefix + "type = " + string_VkObjectEntryTypeNVX(pStruct->type) + "\n";
    final_str = final_str + prefix + "flags = " + ss[0].str() + "\n";
    final_str = final_str + prefix + "pipeline = " + ss[1].str() + "\n";
    return final_str;
}
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #860
std::string vk_print_vkobjecttablepushconstantentrynvx(const VkObjectTablePushConstantEntryNVX* pStruct, const std::string prefix)
...
#endif //VK_USE_PLATFORM_XLIB_KHR
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1059
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1068
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1078
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1085
std::string dynamic_display(const void* pStruct, const std::string prefix)
{
    using namespace std;
    ...
    switch (sType)
    {
        ...
        {
            return vk_print_vkdebugmarkermarkerinfoext((VkDebugMarkerMarkerInfoEXT*)pStruct, indent);
        }
        break;
        case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT:
        {
            return vk_print_vkdebugmarkerobjectnameinfoext((VkDebugMarkerObjectNameInfoEXT*)pStruct, indent);
        }
        break;
        case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT:
        {
            return vk_print_vkdebugmarkerobjecttaginfoext((VkDebugMarkerObjectTagInfoEXT*)pStruct, indent);
        }
        break;
        ...
        {
            return vk_print_vkdedicatedallocationbuffercreateinfonv((VkDedicatedAllocationBufferCreateInfoNV*)pStruct, indent);
        }
        break;
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV:
        {
            return vk_print_vkdedicatedallocationimagecreateinfonv((VkDedicatedAllocationImageCreateInfoNV*)pStruct, indent);
        }
        break;
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV:
        {
            return vk_print_vkdedicatedallocationmemoryallocateinfonv((VkDedicatedAllocationMemoryAllocateInfoNV*)pStruct, indent);
        }
        break;
        ...
        {
            return vk_print_vkexportmemoryallocateinfonv((VkExportMemoryAllocateInfoNV*)pStruct, indent);
        }
        break;
#ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV:
        {
            return vk_print_vkexportmemorywin32handleinfonv((VkExportMemoryWin32HandleInfoNV*)pStruct, indent);
        }
        break;
#endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV:
        {
            return vk_print_vkexternalmemoryimagecreateinfonv((VkExternalMemoryImageCreateInfoNV*)pStruct, indent);
        }
        break;
        ...
        {
            return vk_print_vkimportmemorywin32handleinfonv((VkImportMemoryWin32HandleInfoNV*)pStruct, indent);
        }
        break;
#endif // VK_USE_PLATFORM_WIN32_KHR
        ...
        {
            return vk_print_vkpipelinerasterizationstaterasterizationorderamd((VkPipelineRasterizationStateRasterizationOrderAMD*)pStruct, indent);
        }
        break;
        ...
        {
            return vk_print_vkvalidationflagsext((VkValidationFlagsEXT*)pStruct, indent);
        }
        break;
#ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV:
        {
            return vk_print_vkwin32keyedmutexacquirereleaseinfonv((VkWin32KeyedMutexAcquireReleaseInfoNV*)pStruct, indent);
        }
        break;
#endif // VK_USE_PLATFORM_WIN32_KHR
        ...
        default:
        return string();
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1115
    }
}