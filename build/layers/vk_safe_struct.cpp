...
safe_VkDeviceGeneratedCommandsFeaturesNVX::safe_VkDeviceGeneratedCommandsFeaturesNVX(const VkDeviceGeneratedCommandsFeaturesNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	computeBindingPointSupport(pInStruct->computeBindingPointSupport)
{
}
...
void safe_VkDeviceGeneratedCommandsFeaturesNVX::initialize(const VkDeviceGeneratedCommandsFeaturesNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    computeBindingPointSupport = pInStruct->computeBindingPointSupport;
...
safe_VkDeviceGeneratedCommandsLimitsNVX::safe_VkDeviceGeneratedCommandsLimitsNVX(const VkDeviceGeneratedCommandsLimitsNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	maxIndirectCommandsLayoutTokenCount(pInStruct->maxIndirectCommandsLayoutTokenCount),
	maxObjectEntryCounts(pInStruct->maxObjectEntryCounts),
	minSequenceCountBufferOffsetAlignment(pInStruct->minSequenceCountBufferOffsetAlignment),
	minSequenceIndexBufferOffsetAlignment(pInStruct->minSequenceIndexBufferOffsetAlignment),
	minCommandsTokenBufferOffsetAlignment(pInStruct->minCommandsTokenBufferOffsetAlignment)
{
}
...
void safe_VkDeviceGeneratedCommandsLimitsNVX::initialize(const VkDeviceGeneratedCommandsLimitsNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    maxIndirectCommandsLayoutTokenCount = pInStruct->maxIndirectCommandsLayoutTokenCount;
...
safe_VkIndirectCommandsLayoutCreateInfoNVX::safe_VkIndirectCommandsLayoutCreateInfoNVX(const VkIndirectCommandsLayoutCreateInfoNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	pipelineBindPoint(pInStruct->pipelineBindPoint),
	flags(pInStruct->flags),
	tokenCount(pInStruct->tokenCount),
	pTokens(nullptr)
{
    if (pInStruct->pTokens) {
        pTokens = new VkIndirectCommandsLayoutTokenNVX[pInStruct->tokenCount];
        memcpy ((void *)pTokens, (void *)pInStruct->pTokens, sizeof(VkIndirectCommandsLayoutTokenNVX)*pInStruct->tokenCount);
    }
}
...
void safe_VkIndirectCommandsLayoutCreateInfoNVX::initialize(const VkIndirectCommandsLayoutCreateInfoNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    pipelineBindPoint = pInStruct->pipelineBindPoint;
...
safe_VkCmdProcessCommandsInfoNVX::safe_VkCmdProcessCommandsInfoNVX(const VkCmdProcessCommandsInfoNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	objectTable(pInStruct->objectTable),
	indirectCommandsLayout(pInStruct->indirectCommandsLayout),
	indirectCommandsTokenCount(pInStruct->indirectCommandsTokenCount),
	pIndirectCommandsTokens(nullptr),
	maxSequencesCount(pInStruct->maxSequencesCount),
	targetCommandBuffer(pInStruct->targetCommandBuffer),
	sequencesCountBuffer(pInStruct->sequencesCountBuffer),
	sequencesCountOffset(pInStruct->sequencesCountOffset),
	sequencesIndexBuffer(pInStruct->sequencesIndexBuffer),
	sequencesIndexOffset(pInStruct->sequencesIndexOffset)
{
    if (indirectCommandsTokenCount && pInStruct->pIndirectCommandsTokens) {
        ...
        for (uint32_t i=0; i<indirectCommandsTokenCount; ++i) {
            pIndirectCommandsTokens[i] = pInStruct->pIndirectCommandsTokens[i];
        }
    }
}
...
void safe_VkCmdProcessCommandsInfoNVX::initialize(const VkCmdProcessCommandsInfoNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    objectTable = pInStruct->objectTable;
...
safe_VkCmdReserveSpaceForCommandsInfoNVX::safe_VkCmdReserveSpaceForCommandsInfoNVX(const VkCmdReserveSpaceForCommandsInfoNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	objectTable(pInStruct->objectTable),
	indirectCommandsLayout(pInStruct->indirectCommandsLayout),
...
void safe_VkCmdReserveSpaceForCommandsInfoNVX::initialize(const VkCmdReserveSpaceForCommandsInfoNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    objectTable = pInStruct->objectTable;
...
safe_VkObjectTableCreateInfoNVX::safe_VkObjectTableCreateInfoNVX(const VkObjectTableCreateInfoNVX* pInStruct) : 
	sType(pInStruct->sType),
	pNext(pInStruct->pNext),
	objectCount(pInStruct->objectCount),
	pObjectEntryTypes(nullptr),
	pObjectEntryCounts(nullptr),
	pObjectEntryUsageFlags(nullptr),
	maxUniformBuffersPerDescriptor(pInStruct->maxUniformBuffersPerDescriptor),
	maxStorageBuffersPerDescriptor(pInStruct->maxStorageBuffersPerDescriptor),
	maxStorageImagesPerDescriptor(pInStruct->maxStorageImagesPerDescriptor),
	maxSampledImagesPerDescriptor(pInStruct->maxSampledImagesPerDescriptor),
	maxPipelineLayouts(pInStruct->maxPipelineLayouts)
{
    if (pInStruct->pObjectEntryTypes) {
        pObjectEntryTypes = new VkObjectEntryTypeNVX[pInStruct->objectCount];
        memcpy ((void *)pObjectEntryTypes, (void *)pInStruct->pObjectEntryTypes, sizeof(VkObjectEntryTypeNVX)*pInStruct->objectCount);
    }
    if (pInStruct->pObjectEntryCounts) {
        pObjectEntryCounts = new uint32_t[pInStruct->objectCount];
        memcpy ((void *)pObjectEntryCounts, (void *)pInStruct->pObjectEntryCounts, sizeof(uint32_t)*pInStruct->objectCount);
    }
    if (pInStruct->pObjectEntryUsageFlags) {
        pObjectEntryUsageFlags = new VkObjectEntryUsageFlagsNVX[pInStruct->objectCount];
        memcpy ((void *)pObjectEntryUsageFlags, (void *)pInStruct->pObjectEntryUsageFlags, sizeof(VkObjectEntryUsageFlagsNVX)*pInStruct->objectCount);
    }
}
...
void safe_VkObjectTableCreateInfoNVX::initialize(const VkObjectTableCreateInfoNVX* pInStruct)
{
    sType = pInStruct->sType;
    pNext = pInStruct->pNext;
    objectCount = pInStruct->objectCount;
