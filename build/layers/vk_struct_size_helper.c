...
size_t vk_size_vkcmdprocesscommandsinfonvx(const VkCmdProcessCommandsInfoNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkCmdProcessCommandsInfoNVX);
        uint32_t i = 0;
        for (i = 0; i < pStruct->indirectCommandsTokenCount; i++) {
            structSize += vk_size_vkindirectcommandstokennvx(&pStruct->pIndirectCommandsTokens[i]);
        }
    }
    return structSize;
}
size_t vk_size_vkcmdreservespaceforcommandsinfonvx(const VkCmdReserveSpaceForCommandsInfoNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkCmdReserveSpaceForCommandsInfoNVX);
    }
    return structSize;
}
...
size_t vk_size_vkdevicegeneratedcommandsfeaturesnvx(const VkDeviceGeneratedCommandsFeaturesNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkDeviceGeneratedCommandsFeaturesNVX);
    }
    return structSize;
}
size_t vk_size_vkdevicegeneratedcommandslimitsnvx(const VkDeviceGeneratedCommandsLimitsNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkDeviceGeneratedCommandsLimitsNVX);
    }
    return structSize;
}
...
#endif //VK_USE_PLATFORM_WIN32_KHR
size_t vk_size_vkindirectcommandslayoutcreateinfonvx(const VkIndirectCommandsLayoutCreateInfoNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkIndirectCommandsLayoutCreateInfoNVX);
        uint32_t i = 0;
        for (i = 0; i < pStruct->tokenCount; i++) {
            structSize += vk_size_vkindirectcommandslayouttokennvx(&pStruct->pTokens[i]);
        }
    }
    return structSize;
}
size_t vk_size_vkindirectcommandslayouttokennvx(const VkIndirectCommandsLayoutTokenNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkIndirectCommandsLayoutTokenNVX);
    }
    return structSize;
}
size_t vk_size_vkindirectcommandstokennvx(const VkIndirectCommandsTokenNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkIndirectCommandsTokenNVX);
    }
    return structSize;
}
...
size_t vk_size_vkobjecttablecreateinfonvx(const VkObjectTableCreateInfoNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTableCreateInfoNVX);
        structSize += pStruct->objectCount*sizeof(VkObjectEntryTypeNVX);
        structSize += pStruct->objectCount*sizeof(uint32_t);
        structSize += pStruct->objectCount*sizeof(VkObjectEntryUsageFlagsNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttabledescriptorsetentrynvx(const VkObjectTableDescriptorSetEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTableDescriptorSetEntryNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttableentrynvx(const VkObjectTableEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTableEntryNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttableindexbufferentrynvx(const VkObjectTableIndexBufferEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTableIndexBufferEntryNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttablepipelineentrynvx(const VkObjectTablePipelineEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTablePipelineEntryNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttablepushconstantentrynvx(const VkObjectTablePushConstantEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTablePushConstantEntryNVX);
    }
    return structSize;
}
size_t vk_size_vkobjecttablevertexbufferentrynvx(const VkObjectTableVertexBufferEntryNVX* pStruct)
{
    size_t structSize = 0;
    if (pStruct) {
        structSize = sizeof(VkObjectTableVertexBufferEntryNVX);
    }
    return structSize;
}
...
// CODEGEN : file E:/VulkanSamples/scripts/vk_helper.py line #1338
size_t get_struct_chain_size(const void* pStruct)
{
    ...
    while (pNext) {
        switch (pNext->sType) {
            ...
            {
                structSize += vk_size_vkdebugmarkermarkerinfoext((VkDebugMarkerMarkerInfoEXT*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT:
            {
                structSize += vk_size_vkdebugmarkerobjectnameinfoext((VkDebugMarkerObjectNameInfoEXT*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT:
            {
                structSize += vk_size_vkdebugmarkerobjecttaginfoext((VkDebugMarkerObjectTagInfoEXT*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT:
            {
                structSize += vk_size_vkdebugreportcallbackcreateinfoext((VkDebugReportCallbackCreateInfoEXT*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV:
            {
                structSize += vk_size_vkdedicatedallocationbuffercreateinfonv((VkDedicatedAllocationBufferCreateInfoNV*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV:
            {
                structSize += vk_size_vkdedicatedallocationimagecreateinfonv((VkDedicatedAllocationImageCreateInfoNV*)pNext);
                break;
            }
            case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV:
            {
                structSize += vk_size_vkdedicatedallocationmemoryallocateinfonv((VkDedicatedAllocationMemoryAllocateInfoNV*)pNext);
                break;
            }
            ...
            {
                structSize += vk_size_vkexportmemoryallocateinfonv((VkExportMemoryAllocateInfoNV*)pNext);
                break;
            }
#ifdef VK_USE_PLATFORM_WIN32_KHR
            case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV:
            {
                structSize += vk_size_vkexportmemorywin32handleinfonv((VkExportMemoryWin32HandleInfoNV*)pNext);
                break;
            }
#endif // VK_USE_PLATFORM_WIN32_KHR
            case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV:
            {
                structSize += vk_size_vkexternalmemoryimagecreateinfonv((VkExternalMemoryImageCreateInfoNV*)pNext);
                break;
            }
            ...
            {
                structSize += vk_size_vkimportmemorywin32handleinfonv((VkImportMemoryWin32HandleInfoNV*)pNext);
                break;
            }
#endif // VK_USE_PLATFORM_WIN32_KHR
            ...
            {
                structSize += vk_size_vkpipelinerasterizationstaterasterizationorderamd((VkPipelineRasterizationStateRasterizationOrderAMD*)pNext);
                break;
            }
            ...
            {
                structSize += vk_size_vkvalidationflagsext((VkValidationFlagsEXT*)pNext);
                break;
            }
#ifdef VK_USE_PLATFORM_WIN32_KHR
            case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV:
            {
                structSize += vk_size_vkwin32keyedmutexacquirereleaseinfonv((VkWin32KeyedMutexAcquireReleaseInfoNV*)pNext);
                break;
            }
#endif // VK_USE_PLATFORM_WIN32_KHR
