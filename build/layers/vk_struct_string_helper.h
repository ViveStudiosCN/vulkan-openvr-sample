...
char* vk_print_vkcmdprocesscommandsinfonvx(const VkCmdProcessCommandsInfoNVX* pStruct, const char* prefix);
char* vk_print_vkcmdreservespaceforcommandsinfonvx(const VkCmdReserveSpaceForCommandsInfoNVX* pStruct, const char* prefix);
...
char* vk_print_vkdevicegeneratedcommandsfeaturesnvx(const VkDeviceGeneratedCommandsFeaturesNVX* pStruct, const char* prefix);
char* vk_print_vkdevicegeneratedcommandslimitsnvx(const VkDeviceGeneratedCommandsLimitsNVX* pStruct, const char* prefix);
...
char* vk_print_vkindirectcommandslayoutcreateinfonvx(const VkIndirectCommandsLayoutCreateInfoNVX* pStruct, const char* prefix);
char* vk_print_vkindirectcommandslayouttokennvx(const VkIndirectCommandsLayoutTokenNVX* pStruct, const char* prefix);
char* vk_print_vkindirectcommandstokennvx(const VkIndirectCommandsTokenNVX* pStruct, const char* prefix);
...
char* vk_print_vkobjecttablecreateinfonvx(const VkObjectTableCreateInfoNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttabledescriptorsetentrynvx(const VkObjectTableDescriptorSetEntryNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttableentrynvx(const VkObjectTableEntryNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttableindexbufferentrynvx(const VkObjectTableIndexBufferEntryNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttablepipelineentrynvx(const VkObjectTablePipelineEntryNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttablepushconstantentrynvx(const VkObjectTablePushConstantEntryNVX* pStruct, const char* prefix);
char* vk_print_vkobjecttablevertexbufferentrynvx(const VkObjectTableVertexBufferEntryNVX* pStruct, const char* prefix);
...
char* vk_print_vkcmdprocesscommandsinfonvx(const VkCmdProcessCommandsInfoNVX* pStruct, const char* prefix)
{
    ...
    if (pStruct->pIndirectCommandsTokens) {
        tmpStr = vk_print_vkindirectcommandstokennvx(pStruct->pIndirectCommandsTokens, extra_indent);
        len = 256+strlen(tmpStr)+strlen(prefix);
        stp_strs[1] = (char*)malloc(len);
        snprintf(stp_strs[1], len, " %spIndirectCommandsTokens (0x%p)\n%s", prefix, (void*)pStruct->pIndirectCommandsTokens, tmpStr);
    }
    else
        stp_strs[1] = "";
    len = strlen(stp_strs[0]) + strlen(stp_strs[1]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%sobjectTable = 0x%p\n%sindirectCommandsLayout = 0x%p\n%sindirectCommandsTokenCount = %u\n%spIndirectCommandsTokens = 0x%p\n%smaxSequencesCount = %u\n%stargetCommandBuffer = 0x%p\n%ssequencesCountBuffer = 0x%p\n%ssequencesCountOffset = " PRINTF_SIZE_T_SPECIFIER "\n%ssequencesIndexBuffer = 0x%p\n%ssequencesIndexOffset = " PRINTF_SIZE_T_SPECIFIER "\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, (void*)(pStruct->objectTable), prefix, (void*)(pStruct->indirectCommandsLayout), prefix, (pStruct->indirectCommandsTokenCount), prefix, (void*)(pStruct->pIndirectCommandsTokens), prefix, (pStruct->maxSequencesCount), prefix, (void*)(pStruct->targetCommandBuffer), prefix, (void*)(pStruct->sequencesCountBuffer), prefix, (pStruct->sequencesCountOffset), prefix, (void*)(pStruct->sequencesIndexBuffer), prefix, (pStruct->sequencesIndexOffset));
    for (int32_t stp_index = 1; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkcmdreservespaceforcommandsinfonvx(const VkCmdReserveSpaceForCommandsInfoNVX* pStruct, const char* prefix)
{
    ...
    len = strlen(stp_strs[0]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%sobjectTable = 0x%p\n%sindirectCommandsLayout = 0x%p\n%smaxSequencesCount = %u\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, (void*)(pStruct->objectTable), prefix, (void*)(pStruct->indirectCommandsLayout), prefix, (pStruct->maxSequencesCount));
    for (int32_t stp_index = 0; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkdevicegeneratedcommandsfeaturesnvx(const VkDeviceGeneratedCommandsFeaturesNVX* pStruct, const char* prefix)
{
    ...
    len = strlen(stp_strs[0]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%scomputeBindingPointSupport = %s\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, (pStruct->computeBindingPointSupport) ? "TRUE" : "FALSE");
    for (int32_t stp_index = 0; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkdevicegeneratedcommandslimitsnvx(const VkDeviceGeneratedCommandsLimitsNVX* pStruct, const char* prefix)
{
    ...
    len = strlen(stp_strs[0]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%smaxIndirectCommandsLayoutTokenCount = %u\n%smaxObjectEntryCounts = %u\n%sminSequenceCountBufferOffsetAlignment = %u\n%sminSequenceIndexBufferOffsetAlignment = %u\n%sminCommandsTokenBufferOffsetAlignment = %u\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, (pStruct->maxIndirectCommandsLayoutTokenCount), prefix, (pStruct->maxObjectEntryCounts), prefix, (pStruct->minSequenceCountBufferOffsetAlignment), prefix, (pStruct->minSequenceIndexBufferOffsetAlignment), prefix, (pStruct->minCommandsTokenBufferOffsetAlignment));
    for (int32_t stp_index = 0; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkindirectcommandslayoutcreateinfonvx(const VkIndirectCommandsLayoutCreateInfoNVX* pStruct, const char* prefix)
{
    ...
    if (pStruct->pNext) {
        ...
        stp_strs[0] = "";
    if (pStruct->pTokens) {
        tmpStr = vk_print_vkindirectcommandslayouttokennvx(pStruct->pTokens, extra_indent);
        len = 256+strlen(tmpStr)+strlen(prefix);
        stp_strs[1] = (char*)malloc(len);
        snprintf(stp_strs[1], len, " %spTokens (0x%p)\n%s", prefix, (void*)pStruct->pTokens, tmpStr);
    }
    else
        stp_strs[1] = "";
    len = strlen(stp_strs[0]) + strlen(stp_strs[1]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%spipelineBindPoint = %s\n%sflags = %u\n%stokenCount = %u\n%spTokens = 0x%p\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, string_VkPipelineBindPoint(pStruct->pipelineBindPoint), prefix, (pStruct->flags), prefix, (pStruct->tokenCount), prefix, (void*)(pStruct->pTokens));
    for (int32_t stp_index = 1; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkindirectcommandslayouttokennvx(const VkIndirectCommandsLayoutTokenNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stokenType = %s\n%sbindingUnit = %u\n%sdynamicCount = %u\n%sdivisor = %u\n", prefix, string_VkIndirectCommandsTokenTypeNVX(pStruct->tokenType), prefix, (pStruct->bindingUnit), prefix, (pStruct->dynamicCount), prefix, (pStruct->divisor));
    return str;
}
char* vk_print_vkindirectcommandstokennvx(const VkIndirectCommandsTokenNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stokenType = %s\n%sbuffer = 0x%p\n%soffset = " PRINTF_SIZE_T_SPECIFIER "\n", prefix, string_VkIndirectCommandsTokenTypeNVX(pStruct->tokenType), prefix, (void*)(pStruct->buffer), prefix, (pStruct->offset));
    return str;
}
char* vk_print_vkinstancecreateinfo(const VkInstanceCreateInfo* pStruct, const char* prefix)
{
...
char* vk_print_vkobjecttablecreateinfonvx(const VkObjectTableCreateInfoNVX* pStruct, const char* prefix)
{
    ...
    len = strlen(stp_strs[0]) + sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%ssType = %s\n%spNext = 0x%p\n%sobjectCount = %u\n%spObjectEntryTypes = 0x%p\n%spObjectEntryCounts = 0x%p\n%spObjectEntryUsageFlags = 0x%p\n%smaxUniformBuffersPerDescriptor = %u\n%smaxStorageBuffersPerDescriptor = %u\n%smaxStorageImagesPerDescriptor = %u\n%smaxSampledImagesPerDescriptor = %u\n%smaxPipelineLayouts = %u\n", prefix, string_VkStructureType(pStruct->sType), prefix, (pStruct->pNext), prefix, (pStruct->objectCount), prefix, (void*)(pStruct->pObjectEntryTypes), prefix, (void*)(pStruct->pObjectEntryCounts), prefix, (void*)(pStruct->pObjectEntryUsageFlags), prefix, (pStruct->maxUniformBuffersPerDescriptor), prefix, (pStruct->maxStorageBuffersPerDescriptor), prefix, (pStruct->maxStorageImagesPerDescriptor), prefix, (pStruct->maxSampledImagesPerDescriptor), prefix, (pStruct->maxPipelineLayouts));
    for (int32_t stp_index = 0; stp_index >= 0; stp_index--) {
        if (0 < strlen(stp_strs[stp_index])) {
            strncat(str, stp_strs[stp_index], strlen(stp_strs[stp_index]));
            free(stp_strs[stp_index]);
...
char* vk_print_vkobjecttabledescriptorsetentrynvx(const VkObjectTableDescriptorSetEntryNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stype = %s\n%sflags = %u\n%spipelineLayout = 0x%p\n%sdescriptorSet = 0x%p\n", prefix, string_VkObjectEntryTypeNVX(pStruct->type), prefix, (pStruct->flags), prefix, (void*)(pStruct->pipelineLayout), prefix, (void*)(pStruct->descriptorSet));
    return str;
}
char* vk_print_vkobjecttableentrynvx(const VkObjectTableEntryNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stype = %s\n%sflags = %u\n", prefix, string_VkObjectEntryTypeNVX(pStruct->type), prefix, (pStruct->flags));
    return str;
}
char* vk_print_vkobjecttableindexbufferentrynvx(const VkObjectTableIndexBufferEntryNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stype = %s\n%sflags = %u\n%sbuffer = 0x%p\n", prefix, string_VkObjectEntryTypeNVX(pStruct->type), prefix, (pStruct->flags), prefix, (void*)(pStruct->buffer));
    return str;
}
char* vk_print_vkobjecttablepipelineentrynvx(const VkObjectTablePipelineEntryNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stype = %s\n%sflags = %u\n%spipeline = 0x%p\n", prefix, string_VkObjectEntryTypeNVX(pStruct->type), prefix, (pStruct->flags), prefix, (void*)(pStruct->pipeline));
    return str;
}
char* vk_print_vkobjecttablepushconstantentrynvx(const VkObjectTablePushConstantEntryNVX* pStruct, const char* prefix)
{
    ...
    len = sizeof(char)*1024;
    str = (char*)malloc(len);
    snprintf(str, len, "%stype = %s\n%sflags = %u\n%spipelineLayout = 0x%p\n%sstageFlags = %u\n", prefix, string_VkObjectEntryTypeNVX(pStruct->type), prefix, (pStruct->flags), prefix, (void*)(pStruct->pipelineLayout), prefix, (pStruct->stageFlags));
    return str;
}
char* vk_print_vkobjecttablevertexbufferentrynvx(const VkObjectTableVertexBufferEntryNVX* pStruct, const char* prefix)
{
